...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2018/10/08 19:13:17 by npaulite          #+#    #+#             */
/*   Updated: 2018/10/11 12:34:28 by npaulite         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void		dec_write(t_lst *list, size_t tmp)
{
	if (list->out.below_zero != 1 && list->flag.plus == 1)
		list->data.width -= 1;
	list->out.out = ft_itoa_base((size_t)tmp, 10, 0);
